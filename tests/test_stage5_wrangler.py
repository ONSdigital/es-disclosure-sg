...
class TestWrangler(unittest.TestCase):
    ...
    def test_environment_variable_exception(self):
        with mock.patch.dict('os.environ', {
            ...
            out = stage5_wrangler.lambda_handler(mock_wrangles_event,
                                                 context_object)
    ...
    def test_happy_path(self):
        ...
        with mock.patch.dict('os.environ', {
            'period': 'mock_checkpoint',
            'sns_topic_arn': 'not_an_arn',
            'method_name': 'mock_method',
            'sqs_message_group_id': 'Bertie Bucket',
            ...
            with open('tests/fixtures/factorsdata.json') as file:
                s3_data = file.read()
            with open('tests/fixtures/test_s3_data.json', "r") as file:
                lambda_return = file.read()
            with mock.patch("stage5_wrangler.aws_functions") as mock_funk:
                with mock.patch('stage5_wrangler.boto3.client') as mock_boto:
    ...
    def test_key_error(self):
        with mock.patch.dict('os.environ', {
            ...
            out = stage5_wrangler.lambda_handler({
                  "Jam": {}}, context_object)
            assert(not out['success'])
    ...
    def test_attribute_error(self):
        ...
        with mock.patch.dict('os.environ', {
            ...
            with mock.patch("stage5_wrangler.aws_functions.get_dataframe") as mock_sqs:
                with mock.patch('stage5_wrangler.boto3.client') as mock_boto:
    ...
    def test_method_error(self):
        ...
        with mock.patch.dict('os.environ', {
            ...
            with open('tests/fixtures/factorsdata.json') as file:
                s3_data = file.read()
            with mock.patch("stage5_wrangler.aws_functions.get_dataframe") as mock_funk:
                with mock.patch('stage5_wrangler.boto3.client') as mock_boto:
