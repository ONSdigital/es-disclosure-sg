...
class TestWrangler(unittest.TestCase):
    ...
    def test_environment_variable_exception(self):
        with mock.patch.dict('os.environ', {
            ...
            out = stage1_wrangler.lambda_handler(mock_wrangles_event,
                                                 context_object)
    ...
    def test_key_error(self):
        with mock.patch.dict('os.environ', {
            ...
            out = stage1_wrangler.lambda_handler({
                  "Jam": {}}, context_object)
            assert(not out['success'])
    ...
    def test_happy_path(self):
        ...
        with mock.patch.dict('os.environ', {
            ...
            with mock.patch("stage1_wrangler.aws_functions") as mock_funk:
    ...
    def test_attribute_error(self):
        ...
        with mock.patch.dict('os.environ', {
            ...
            with mock.patch("stage1_wrangler.aws_functions.get_dataframe") as mock_sqs:
                with mock.patch('stage1_wrangler.boto3.client') as mock_boto:
    ...
    def test_method_error(self):
        ...
        with mock.patch.dict('os.environ', {
            ...
            with open('tests/fixtures/factorsdata.json') as file:
                s3_data = file.read()
            with mock.patch("stage1_wrangler.aws_functions.get_dataframe") as mock_funk:
                with mock.patch('stage1_wrangler.boto3.client') as mock_boto:
                    mock_boto.return_value.invoke.return_value.get.return_value \
                        .read.return_value.decode.return_value = \
                        json.dumps({"error": "This is an error message",
                                    "success": False})
                    mock_funk.return_value = pd.DataFrame(json.loads(s3_data)), 666
                    out = stage1_wrangler.lambda_handler(mock_wrangles_event,
                                                         context_object)
